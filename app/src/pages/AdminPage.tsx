        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-4 py-2 bg-yellow-400 text-black text-sm font-bold rounded-xl hover:bg-yellow-500 transition-all flex items-center gap-2"
            >
            ...
            <a href="/" className="px-4 py-2 bg-gray-100 text-gray-600 text-sm font-semibold rounded-xl hover:bg-gray-200 transition-colors">
              ← На сайт
            </a>
          </div>
        </div>
